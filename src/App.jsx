...
function GuidePage() {
  const histo = [
    ...
    { year: "2019", title: "L'arrivée de Nicolas", text: <><b>Nicolas Richard</b>, actuel secrétaire, rejoint l'association — une arrivée décisive pour la suite.</> },
    { year: "2020", title: "Pause forcée", text: <>Les contraintes du Covid mettent l'association en sommeil… officiellement. Car c'est <b>Nicolas Richard</b> qui maintient le lien entre les membres pendant toute la période (2020-2022), en organisant chez lui des soirées <b>jeux Détective</b> et une campagne <b>Gloomhaven</b>. Les boîtes de l'association prennent la poussière — pas les joueurs.</> },
